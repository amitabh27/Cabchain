...
public class RideBegin extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,PlaceSelectionListener,OnMapReadyCallback,LocationListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener
{
    ...
    String phone,username,email,ridetrackingno,GPSstart,GPSend,userphone,customername,driverlatiude,driverlongitude,fare,distance,time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_begin);
        ...
        driverlatiude=getIntent().getStringExtra("driverlatitude");
        ...
        userlatitude=Double.parseDouble(GPSend.substring(0, GPSend.indexOf(" ")));
        userlongitude=Double.parseDouble(GPSend.substring(GPSend.indexOf(" ")+1));


      /*  String myurl="https://maps.googleapis.com/maps/api/directions/json?origin="+driverlatiude+","+driverlongitude+"&destination="+userlatitude+","+userlongitude+"&sensor=false&mode=driving&alternatives=true&key=AIzaSyCweXwBZ82TU1ZdOCFoDFYhx9l75vh6E50";
...
*/
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       // double driverlat=Double.parseDouble(driverlatiude);
        ...
        dest=new LatLng(userlatitude,userlongitude);
    ...
    public void placeRequest(View view){
        ...
        Intent show = new Intent(this, FinishRide.class);

        String url="https://cabchain.herokuapp.com/users/sendinvoice/"+ridetrackingno;
        HttpGetRequest getRequest = new HttpGetRequest();
        try {
        ...
        url="https://cabchain.herokuapp.com/users/smsinvoice/"+ridetrackingno;
